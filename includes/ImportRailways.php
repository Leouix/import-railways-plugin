...
class ImportRailways
{
     ...
     * @throws Exception
     */
    public function importFormRailwaysHandler(): void
    {
     ...
     * @throws Exception
     */
    private function handlerXlsx(array $arrayOfArrays): void
    {
     ...
     * @throws Exception
     */
    private function handlerEn(): void
    {
        delete_field($this->fields['repeaterKey'], $this->pageIdEn);
        $this->setRepeaterEn();
    }

    private function clearData(array $arrayOfArrays): array
    {
        $data = [];
     ...
     * @throws Exception
     */
    private function setRepeaterRu(): void
    {
        $values = [];
     ...
     * @throws Exception
     */
    private function setRepeaterEn(): void
    {
        $values = [];
        foreach($this->xlsx as $index => $importRow) {
     ...
     * @throws Exception
     */
    public function getStationIdRu(string $nameStation): WP_Error|int
    {
     ...
     * @throws Exception
     */
    public function getStationIdEn(string $nameStation): WP_Error|int
    {
        $stationId = array_search($nameStation, $this->allStations);
        if (!$stationId) {
            $stationId = $this->createStation($nameStation);
     ...
     * @throws Exception
     */
    public function createStation($title): WP_Error|int
    {
        $newStation = array(
    ...
    private function setStationTypes(int $stationId, array $termsId, string $locale): void
    {
    ...
    private function transliterate(string $nameStation): string
    {
        $cyr = array(
